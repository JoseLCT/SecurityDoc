...
public class Lista<E> implements Iterable<E>, Serializable {
    ...
    /**
     * El nuevo elemento que se agrega a la lista es el primero de la lista.
     * La raiz es el nuevo elemento.
     */
    ...
    /**
     * El nuevo elemento que se agrega a la lista es el último de la lista.
     * La raiz será el primer elemento que se agrega a la lista.
     */
